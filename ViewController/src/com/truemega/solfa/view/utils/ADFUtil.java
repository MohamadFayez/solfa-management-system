...
public class ADFUtil {
    ...
    public static void executeVoidOperation(String operationName, Map.Entry... param) throws Exception {
        OperationBinding operation = findOperation(operationName);
        if (param != null) {
            Map map = operation.getParamsMap();
            for (Map.Entry entry : param) {
    ...
    public static void uploadFile(UploadedFile myFile, String fileName, String extension, String filePath) {
        if (myFile != null) {
            if (extension != null)
                if (myFile.getFilename().endsWith("." + extension)) {
                    ...
                    showMessage("File " + fileName + " Extension must Be " + extension, FacesMessage.SEVERITY_ERROR);
                }

        } else {
            showMessage("Please select a file", FacesMessage.SEVERITY_ERROR);
        }
        return;
    }
    
    public static void uploudZipFile(String zipName){
